...
|                             MediaPipe Holistic Model                              |                            ConvexHull                             |                            SpringBatch                             |                               캐릭터 수집 및 커스터마이징                               |
| :---------------------------------------------------------: | :---------------------------------------------------------: | :---------------------------------------------------------: | :---------------------------------------------------------------------: |
| ![미디어_파이프](/README/tech_intro/mediapipe.png) | ![컨벡스_헐](/README/tech_intro/convex_hull.png) | ![양치](/README/about_app/tooth_brush.png) | ![모자꾸미기](/README/about_app/accessory.png) |
